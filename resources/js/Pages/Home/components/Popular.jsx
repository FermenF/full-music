    ...
    return(
        <div className="w-full h-full bg-black rounded-3xl">
            <div className="flex w-full md:p-14 p-5 justify-between md:justify-start">
                <div className="flex-grow">
                    <div className="text-left flex">
                        <button className="text-white font-bold bg-transparent border-2 border-white rounded-3xl p-2" style={{ letterSpacing: '1px' }}>Popular</button>
                        <button className="flex items-center text-white bg-transparent border-2 border-white rounded-3xl p-2">
                ...
                <div className="text-right">
                    <button className="text-white border-white border bg-black p-3 md:p-6 rounded-full">
            ...
            <div className="flex w-full md:14 p-5 justify-center">
                <button className="text-white font-bold bg-transparent border-2 border-white rounded-3xl p-2" style={{ letterSpacing: '1px' }}>Explore</button>
                <button className="text-white font-bold bg-transparent border-2 border-white rounded-3xl p-2 flex items-center" style={{ letterSpacing: '1px' }}>
                    <div>Ruido Audio</div>
