        ...
        <div className="w-full h-full rounded-3xl flex flex-col justify-between" style={bgImage}>
            <div className="flex w-full lg:p-14 md:p-3 p-6 justify-between md:justify-start">
                ...
                <div className="text-right">
                    <button className="text-black bg-white lg:p-6 p-3 md:p-4 rounded-full hover:bg-slate-400">
                        <svg className="lg:w-6 lg:h-6 md:w-3 md:h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
