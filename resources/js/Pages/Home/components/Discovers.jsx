            ...
            <div className="flex w-full md:p-14 md:pb-0 p-5 pb-0 justify-between md:justify-start">
                <div className="flex-grow">
                    <div className="text-left flex">
                        <button className="text-white font-bold bg-transparent border-2 border-white rounded-3xl p-2" style={{ letterSpacing: '1px' }}>Discovers</button>
                ...
                <div className="text-right">
                    <button className="text-white bg-black p-3 md:p-6 rounded-full">
