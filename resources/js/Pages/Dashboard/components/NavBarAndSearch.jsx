        ...
        <div className="text-white w-full bg-gray-950 mb-2 py-6 px-4 rounded-md">
            <div className="flex items-center justify-between">
                ...
                <div className="md:hidden">
                    <div>
                        <button id="dropdownDefault" data-dropdown-toggle="dropdown" className="inline-flex items-center p-1 px-2 text-sm font-normal text-center text-gray-600 bg-gray-200 rounded-lg hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-100">
                            { name }
