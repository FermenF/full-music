...
const AudioController = () => {
    ...
    const { song: { url }, prevSong, nextSong } = useContext(SongContext);
    ...
    useEffect(() => {
        ...
        const handleTimeUpdate = () => {
            ...
            // Verificar si duration es un número válido antes de usarlo
    ...
    return (
        <div className="w-96">
            <div className="flex items-center justify-center my-2">
                <button className="mx-1 rounded-full p-2 hover:bg-black" onClick={ handlePrevSong }>
                ...
                <button type="button" className="mx-1 rounded-full p-2 hover-bg-black" onClick={ nextSong }>
