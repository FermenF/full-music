    ...
    return(
        <div className="flex justify-between text-white py-4 px-10 bg-slate-950 rounded-t-md">
            <div className="flex">
                ...
                <button className="bg-slate-800 p-2 rounded-full ml-0.5">
                    <svg className="w-6 h-4 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 13 5.7-5.326a.909.909 0 0 0 0-1.348L1 1"/>
                    </svg>
                </button>
            </div>
            <button className="flex items-center bg-red-100 p-2 rounded hover:bg-red-200 hover:text-gray-500">
                ...
                <strong className="mr-2 text-gray-900">{ user.name }</strong>
